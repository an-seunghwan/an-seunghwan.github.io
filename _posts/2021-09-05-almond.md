...
만약 우리가 $t$시점에서 $t+1$ 시점으로의 $\beta$에 대한 update를 생각한다면, 고정된 $\tilde{\beta}$를 $\beta_{t}$으로 놓을 수 있다. 따라서 

$$f_{\beta_t}(x|h_{\eta}(z)) \pi_0(z)$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyMTYxNDk3NCwtMTgwOTY3MzUxNywtOD
cwNDEwMTcxXX0=
-->