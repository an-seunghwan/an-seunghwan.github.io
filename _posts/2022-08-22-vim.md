...
- oracle residual prediction function $f_{0,s}: x \mapsto I(Q_{0,s}(1, x) > Q_{0,s}(0, x))$
	- define $Q_{0,s}$ as $Q_{0,s} := \mathbb{E}_0 [Q_0(a, x) \vert X_{-s} = x_{-s} ] = \mathbb{E}_0 [\mathbb{E}_0 [Y  \vert A=a, X=x] \vert X_{-s} = x_{-s} ] = \mathbb{E}_0 [Y  \vert A=a, X_{-s} = x_{-s}]$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjI3NjI2NTc0LC0yMTMzNjU2MDA3LDE2OD
g5ODkwODAsMTY0MDkzOTI4LC0xOTIxMTE3MDM0LDc0NDA4MDM0
OSwtMTY5OTI1MzExMiwtOTcyNjkyMTQwLDE1NzM3MTg4MzMsLT
IxNTc5NzA0OCwtNTkzNzMwNTg0LC02NDI1MzE3MzksLTY3OTcz
NTkzNCwxMTY3OTIyMDUxLDExMTE0ODEyMzhdfQ==
-->