...
- oracle residual prediction function $f_{0,s}: x \mapsto I(Q_{0,s}(1, x) > Q_{0,s}(0, x))$
	- define $Q_{0,s}$ as $Q_{0,s} := \mathbb{E}_0 [Q_0(a, x) \vert X_{-s} = x_{-s} ] = \mathbb{E}_0 [\mathbb{E}_0 [Y  \vert A=a, X=x]| X_{-s} = x_{-s} ] = \mathbb{E}_0 [Y  \vert A=a, X_{-s} = x_{-s}]$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMzM2NTYwMDcsMTY4ODk4OTA4MCwxNj
QwOTM5MjgsLTE5MjExMTcwMzQsNzQ0MDgwMzQ5LC0xNjk5MjUz
MTEyLC05NzI2OTIxNDAsMTU3MzcxODgzMywtMjE1Nzk3MDQ4LC
01OTM3MzA1ODQsLTY0MjUzMTczOSwtNjc5NzM1OTM0LDExNjc5
MjIwNTEsMTExMTQ4MTIzOF19
-->