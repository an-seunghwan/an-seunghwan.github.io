...
- $\mathcal{F}_s := \{f \in \mathcal{F}: f(u) = f(v) \textrm{ for all } u, v \in \mathcal{X} \textrm{ satisfying } u_{-s} = v_{-s}\}$: $s$에 의존하지 않는 함수들로 구성된 집합
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzE2NzA0NTIwLDE2NDA5MzkyOCwtMTkyMT
ExNzAzNCw3NDQwODAzNDksLTE2OTkyNTMxMTIsLTk3MjY5MjE0
MCwxNTczNzE4ODMzLC0yMTU3OTcwNDgsLTU5MzczMDU4NCwtNj
QyNTMxNzM5LC02Nzk3MzU5MzQsMTE2NzkyMjA1MSwxMTExNDgx
MjM4XX0=
-->