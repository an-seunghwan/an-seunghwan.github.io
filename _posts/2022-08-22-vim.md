...
- $\mathcal{F}_s := \{f \in \mathcal{F}: f(u) = f(v) \text{ for all } u, v \in \mathcal{X} \text{ satisfying } u_{-s} = v_{-s}\}$: $s$에 의존하지 않는 함수들로 구성된 집합
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY0MDkzOTI4LC0xOTIxMTE3MDM0LDE2ND
A5MzkyOCw3NDQwODAzNDksLTE2OTkyNTMxMTIsLTk3MjY5MjE0
