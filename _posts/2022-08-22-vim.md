---
title: "Inference on Variable Importance Measure 1편"
...
- oracle residual prediction function $f_{0,s}: x \mapsto I(Q_{0,s}(1, x) > Q_{0,s}(0, x))$
	- define $Q_{0,s}$ as 
$$
Q_{0,s} := \mathbb{E}_0 [Q_0(a, x) \vert X_{-s} = x_{-s} ] 
$$

$$ 
= \mathbb{E}_0 [\mathbb{E}_0 [Y  \vert A=a, X=x] \vert X_{-s} = x_{-s} ] 
$$

$$
= \mathbb{E}_0 [Y  \vert A=a, X_{-s} = x_{-s}]
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjU2NDE1MDIsMTYxMzY1MjE2NywtMT
c2NDg1MDg0OCwyMTQ1MjAxNDMwLDYyNzYyNjU3NCwtMjEzMzY1
NjAwNywxNjg4OTg5MDgwLDE2NDA5MzkyOCwtMTkyMTExNzAzNC
w3NDQwODAzNDksLTE2OTkyNTMxMTIsLTk3MjY5MjE0MCwxNTcz
NzE4ODMzLC0yMTU3OTcwNDgsLTU5MzczMDU4NCwtNjQyNTMxNz
M5LC02Nzk3MzU5MzQsMTE2NzkyMjA1MSwxMTExNDgxMjM4XX0=
