...
단순 선형 회귀분석을 하는 custom layer `MCPLayer`를 정의하고, `add_loss`를 이용해 MCP penalty를 loss에 추가해준다.
```python
...
================================================================= 
Total params: 100 Trainable params: 100 Non-trainable params: 0 _________________________________________________________________
```
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkwMjQ4NDg4MiwxNDA3Nzc5MDRdfQ==
-->