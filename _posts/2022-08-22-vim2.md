...
6. $V(f_{n, s}, \hat{P}_n) = \frac{1}{n}\sum_{i=1}^n \frac{1}{n}\sum_{i=1}^n \hat{\mathbb{E}}[Y \vert A=f_{n, s}(X_i), X=X_i]$
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwODY4MTE1ODIsLTE3ODMyODMwNDcsMT
gzNzg2MDgyMiwyMDUwOTc5MTU4LDY4MDM3NTY2OF19
-->