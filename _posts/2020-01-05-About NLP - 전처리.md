...
전체 단어 개수: 11569
```
이때, 단어의 index가 1부터 시작하므로 후에 단어 embedding matrix를 구축하기 위해 전체 단어 개수를 저장해 놓을 때, `len(vocab)+1`fh
...
추가 정제 - 불용어 제거
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQwNzc5ODc3OSw2MjMxMDgzODYsLTEyMz
A1NDEwOTksLTM0Mjg4MTE0NiwxMjEzNjAxMzAwLDcwNjYyODI3
NiwtMjYyOTgzNzU5XX0=
-->