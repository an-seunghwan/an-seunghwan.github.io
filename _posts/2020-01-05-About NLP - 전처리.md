...
사전에 필요 없는 단어의 목록을 안다면, 이러한 단어들을 corpus에서 제거하는 것도 정제화의 한가지 방법이다. 예를 들어, 한글 기사 데이터를 이용해 감성 분석을 진행한다면, '기자, 신문, 일보, 뉴스'와 같은 단어는 감성 분석에 있어 불필요한 다
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTcyNTA2NTg1LDc5NzY4Nzc2NCwtMTQwMD
