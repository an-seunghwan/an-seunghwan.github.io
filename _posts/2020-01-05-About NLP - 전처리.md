...
sequence의 최대 길이: 47
```
여기서는 sequence의 최대 길이를 이용해 padding을 하였지만, 일반적으로 중간값을 사용한다. 하지만 중간값보다 sequence sample의 길이가 길다면, `maxl

한글화의 치명적인 단점

추가 정제 - 불용어 제거
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3ODE0NDU2NDYsLTE0MDAzNzg0NjAsNj
IzMTA4Mzg2LC0xMjMwNTQxMDk5LC0zNDI4ODExNDYsMTIxMzYw
MTMwMCw3MDY2MjgyNzYsLTI2Mjk4Mzc1OV19
-->