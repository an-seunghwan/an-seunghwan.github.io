...
('냉무', 11569)
```
전체 단어 사전의 마지막 단어인 '냉무'는 만약 embedding matrix가 `(len(vocab), embedding_size)`이라면 
...
추가 정제 - 불용어 제거
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NzU2NjA0MTMsNjIzMTA4Mzg2LC0xMj
MwNTQxMDk5LC0zNDI4ODExNDYsMTIxMzYwMTMwMCw3MDY2Mjgy
NzYsLTI2Mjk4Mzc1OV19
-->