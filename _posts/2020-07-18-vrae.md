...
dropout에 해당되는 단어들은 `<UNK>`라는 특수 단어로 변환되어 입력에 사용된다. 극단적으로 dropout ratio가 1인 경우, 모든 decoder의 input이 `<UNK>`으로 변환되어 de
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTMxMDcyOTYsLTE3NjQ3MTA2NzMsMz
c0NDEyNDk3XX0=
-->