...
기존의 DNN(deep neural network)은 고정된 길이의 input과 output에 대해서만 적용이 가능하다는 문제를 가지고 있다. 따라서, 미리 output의 데이터 길이를 알지 못하는 경우에는 DNN을 사용할 수 없다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ3OTQ5MzI3NiwtMjAwOTc0OTk2MCwyMT
E2MjA0NzUwXX0=
-->