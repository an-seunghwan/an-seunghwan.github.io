...
이러한 길이가 제한되지 않는 유연한 sequence 형태의 데이터를 다루기 위한 방법론으로 sequence to sequence mapping 방법론이 제시되었다. 이는 흔히 **seq2seq** 모형으로 불리며 이를 구성하는 방법은 매우 다양하다(RNN, LSTM, GRU 등). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTM5NjgwNDMsLTIwMDk3NDk5NjAsMjExNj
IwNDc1MF19
-->