...
`input_shape=(16, 64)`은 input sequence의 차원을 결정하는 argument이다. 이는 다르게 표현하면 `input_shape=(timesteps, input_dim)`이다. `timestep=input_length=16`는 기계번역의 경우에 input sequence의 길이, 즉 문장의 길이가 16임을 나타낸다. `input_dim=embedding_size`=$d_{\mathbf{x}}$=64라고 할 수 있다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzI1Njk3Mzc2LC0xNzI4NjIwNDUwLDY4Nj
EwNjc5NywtMTcwOTY5ODUwMCwxOTMwMjczMDg0LC0xOTU2NTI2
Mjg4LDE5NzExNDAyMDMsLTExODMzMjg2MzAsLTkxNDk4MjU2Mi
wtMjA2Nzk4NTIyOCwtMTEwNzc4MTc1N119
-->