...
Keras에서 RNN layer를 구현하기 위해서는 `layers.SimpleRNN`을 사용하면 된다. 이 class의 arguments들의 의미를 하나씩 살펴보자. 우선 `units=32`는 hidden state의 차원을 결정하는 argument로 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ4NjM2NTg2OCwtMTg2OTI2NzI3OCwtMT
