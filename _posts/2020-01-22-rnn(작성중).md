...
$t$ 시점의 경우
- $\mathbf{x}_t$: input sequence data, shape = ($d_{\mathbf{x}}$, 1)
- $\mathbf{h}_t$: hidden state, shape = ($d_{\mathbf{h}}$, 1)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NjE5Mzc1OTQsMTMzNTkwNjk0OCwtMT
I3OTQzOTc0MSwtMTkyNzYzNzE1MiwtMTAzMDQ4MzU3NF19
-->