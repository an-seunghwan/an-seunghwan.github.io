...
하지만, 기계번역에서 예측하려는 단어와 그 단어와 관련한 맥락 단어들의 거리가 먼 경우, RNN 모형을 이용해서는 이러한 관계를 학습하기가 매우 어렵다. 예를 들면, "나는 통계를 전공하고 현재 4학년 학부생... 그래서 나는 ___ 과목에 제일 자신있어."라는 문장이 주어진 경우에는, 예측하려는 단어("통계")와 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNTA3NDc3ODIsLTEyNzk0Mzk3NDEsLT
E5Mjc2MzcxNTIsLTEwMzA0ODM1NzRdfQ==
-->