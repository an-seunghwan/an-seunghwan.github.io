...
`input_shape=(16, 64)`은 input sequence의 차원을 결정하는 argument이다. 이는 다르게 표현하면 `input_sequence=(timesteps, input_dim)`이므로 `timestep=16`, `input_dim=64(=embedding_size)`라고 할 수 있다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NjQzMzc0MjcsLTE4NjkyNjcyNzgsLT
