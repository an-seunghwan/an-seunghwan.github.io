...
- $\textbf{x}_t$: $t$th timestep input of sequence, shape = ($d_{\mathbf{x}}$, 1)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjAxNDAxMDY2LDEzMzU5MDY5NDgsLTEyNz
k0Mzk3NDEsLTE5Mjc2MzcxNTIsLTEwMzA0ODM1NzRdfQ==
-->