...
그렇다면 `return_sequences`의 역할을 알아보자. `return_sequences`는 각 RNN cell에서 계산되는 hidden state에 대한 return 여부를 나타낸다. 즉, 앞
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MjMxNzc2LDE2MjQ1MTc1MzgsLTE4Nj
