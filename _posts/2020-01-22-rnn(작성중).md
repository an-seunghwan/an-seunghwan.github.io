...
_________________________________________________________________
```
`batch_size`에 대한 별도의 지정이 없다면 input sequence의 길이인 16개의 hidden state이 return되므로 (16, 32)의 shape을 가지는 행렬이 returnehls
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgyODUzMjg3NSwxNjI0NTE3NTM4LC0xOD
