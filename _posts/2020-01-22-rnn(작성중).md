...
$\mathbf{x}_t$ : $t$ timestep input of sequence, shape = ($d_{\mathbf{x}}$, 1)

$\mathbf{h}_{t}$ : hidden state corresponding to $t$ timestep input, shape = ($d_{\mathbf{h}}$, 1)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MTY4NzMwMzIsLTE0ODE1NDAyNDIsNj
