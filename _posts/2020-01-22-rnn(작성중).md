...
따라서 $d_{\mathbf{x}}$는 embedding 차원의 크기(embedding size)라고 할 수 있다. 그리고 하나의 RNN layer는 가중치 $\mathbf{W}_\mathbf{x}, \mathbf{W}_\mathbf{h}, \mathbf{W}_\mathbf{y}$를 모든 시점(timestep)에 대해서 동일하게 사용한다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NjkyNjcyNzgsLTE0NTE0MTI1NjUsMT
g3MzI5ODg3NywxODQ3NjkyNjUyLC0xNDgxNTQwMjQyLDYwMTQw
MTA2NiwxMzM1OTA2OTQ4LC0xMjc5NDM5NzQxLC0xOTI3NjM3MT
UyLC0xMDMwNDgzNTc0XX0=
-->