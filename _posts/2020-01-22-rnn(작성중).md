...
\textbf{y}: \text{sequence format data} \in \mathbb{R}^{T^{'}} \\
t: \text{timestep}
$$
...
$$
\dots \rightarrow \textbf{x}_t \rightarrow \text{RNN cell $t$} \rightarrow \textbf{h}_t \rightarrow \text{RNN cell $t+1$
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MTYxNDAxNjZdfQ==
-->