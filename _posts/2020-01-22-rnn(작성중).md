...
- $\mathbf{x}_t$: $t$th timestep input of sequence, shape = ($d_{\mathbf{x}}$, 1)
- $\mathbf{h}_t$: hidden state corresponding to $t$th timestep input, shape = ($d_{\mathbf{h}}$, 1)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzOTc5MjU2NCwxMzM1OTA2OTQ4LC0xMj
