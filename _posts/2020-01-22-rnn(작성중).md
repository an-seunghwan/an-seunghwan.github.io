...
위 사진은 RNN  모형의 일부분을 나타내는 것이다. 이때 **cell**은 DNN hidden layer의 node에 대응되는 역할이라고 생각하면 된다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjIzMDEzNjEsLTE5Mjc2MzcxNTIsLT
EwMzA0ODM1NzRdfQ==
-->