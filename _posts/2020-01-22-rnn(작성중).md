...
`input_shape=(16, 64)`은 input sequence의 차원을 결정하는 argument이다. 이는 다르게 표현하면 `input_sequence=(timesteps, embedding_size)`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM1NjQ5MzI3NywtMTg2OTI2NzI3OCwtMT
