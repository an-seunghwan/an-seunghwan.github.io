...
RNN의 loop(chain)과 같은 형태는 이전의 정보를 현재의 문제와 연결해준다는 아주 매력적인 점이 있다. 하지만 현재의 과제를 처리하기 위해 최근의 정보만이 필요한 경우가 많다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY3Njg3ODQyMiwtMTkyNzYzNzE1MiwtMT
AzMDQ4MzU3NF19
-->